...
def data_writing(file_path, data,mode="w"):
    ...
    with open(file_path, mode,  encoding="utf-8") as f:
        for element in data["MRData"]["StandingsTable"]["StandingsLists"][0]["ConstructorStandings"]:
        ...
        print(f"Se guardaron {len(data["MRData"]["StandingsTable"]["StandingsLists"][0]["ConstructorStandings"])} elementos en {file_path}")
...
data_writing("data/raw/team_info.json", f1_data, "w")
