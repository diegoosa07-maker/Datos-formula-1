...
def json_to_json(file_path):
    out = []
    diccionario = crear_diccionario_drivers('data/raw/pilotos2023_info.json')
    ...
    with open("data/raw/driverspodium2023.json", "w", encoding="utf-8") as f:
        for fila in out:
...
json_to_json("data/raw/driverspoints2023_data.json")
json_to_csv("data/raw/driverspodium2023.json")