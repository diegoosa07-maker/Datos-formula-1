# Nombre original 2023nombres.py 
import os
import json
import csv
...
def json_to_json(file_path):
    out = []
    diccionario = crear_diccionario_drivers('data/raw/info/pilotos2023_info.json')
    ...
    with open("data/raw/podium/driverspodium2023.json", "w", encoding="utf-8") as f:
        for fila in out:
...
json_to_json("data/raw/puntos/driverspoints2023_data.json")
def json_to_csv(file_path):
    ...
    with open("data/clean/driverspodium2023.csv", "w", newline="", encoding="utf-8") as csv_file:
        writer = csv.DictWriter(csv_file, fieldnames=fieldnames, extrasaction="ignore")
        writer.writeheader()
        writer.writerows(out)

json_to_json("data/raw/puntos/driverspoints2023_data.json")
json_to_csv("data/raw/podium/driverspodium2023.json")