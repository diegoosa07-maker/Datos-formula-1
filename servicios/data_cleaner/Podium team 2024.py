...
def json_to_json(file_path):
    ...
    with open("data/raw/podium/teamspodium2024.json", "w", encoding="utf-8") as f:
        for fila in out:
...
json_to_json("data/raw/puntos/teamspoints2024_data.json")
json_to_csv("data/raw/podium/teamspodium2024.json")