...
def json_to_json(file_path):
    out = []
    diccionario = crear_diccionario_drivers('data/raw/info/pilotos2025_info.json')
    ...
    with open("data/raw/podium/driverspodium2025.json", "w", encoding="utf-8") as f:
        for fila in out:
...
json_to_json("data/raw/puntos/driverspoints2025_data.json")
...
json_to_json("data/raw/puntos/driverspoints2025_data.json")
json_to_csv("data/raw/podium/driverspodium2025.json")