...
def json_to_json(file_path):
    ...
    with open("data/raw/calendario/calendario2024.json", "w", encoding="utf-8") as f:
        for fila in out:
...
def json_to_csv(file_path):
    ...
    with open("data/clean/calendario2024.csv", "w", newline="", encoding="utf-8") as csv_file:
        writer = csv.DictWriter(csv_file, fieldnames=fieldnames, extrasaction="ignore")
        writer.writeheader()
        writer.writerows(out)

json_to_json("data/raw/carreras/carreras_2024.json")
json_to_csv("data/raw/calendario/calendario2024.json")