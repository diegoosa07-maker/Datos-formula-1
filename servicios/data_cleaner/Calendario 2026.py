...
def json_to_json(file_path):
    ...
    with open("data/raw/calendario/calendario2026.json", "w", encoding="utf-8") as f:
        for fila in out:
...
json_to_json("data/raw/carreras/carreras_2026.json")
json_to_csv("data/raw/calendario/calendario2026.json")